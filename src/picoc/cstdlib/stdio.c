...
static const int L_tmpnamValue = L_tmpnam;
...
/* rotable for core stdio variables */
const PICOC_RO_TYPE stdio_variables[] = {
    {STRKEY("EOF"), INT(EOFValue)},
...
const PICOC_REG_TYPE StdioFunctions[] = {
    ...
    { FUNC(StdioFerror),   PROTO("int ferror(FILE *);") },
    { FUNC(StdioFileno),   PROTO("int fileno(FILE *);") },
    { FUNC(StdioFflush),   PROTO("int fflush(FILE *);") },
    { FUNC(StdioFgetpos),  PROTO("int fgetpos(FILE *, int *);") },
    { FUNC(StdioFsetpos),  PROTO("int fsetpos(FILE *, int *);") },
    { FUNC(StdioFtell),    PROTO("int ftell(FILE *);") },
    { FUNC(StdioFseek),    PROTO("int fseek(FILE *, int, int);") },
    { FUNC(StdioPerror),   PROTO("void perror(char *);") },
    { FUNC(StdioPutc),     PROTO("int putc(char *, FILE *);") },
    { FUNC(StdioPutchar),  PROTO("int putchar(int);") },
    { FUNC(StdioPutchar),  PROTO("int fputchar(int);") },
    { FUNC(StdioSetbuf),   PROTO("void setbuf(FILE *, char *);") },
    { FUNC(StdioSetvbuf),  PROTO("void setvbuf(FILE *, char *, int, int);") },
    { FUNC(StdioUngetc),   PROTO("int ungetc(int, FILE *);") },
    { FUNC(StdioPuts),     PROTO("int puts(char *);") },
    { FUNC(StdioGets),     PROTO("char *gets(char *);") },
    { FUNC(StdioGetchar),  PROTO("int getchar();") },
    { FUNC(StdioPrintf),   PROTO("int printf(char *, ...);") },
    { FUNC(StdioFprintf),  PROTO("int fprintf(FILE *, char *, ...);") },
    { FUNC(StdioSprintf),  PROTO("int sprintf(char *, char *, ...);") },
    { FUNC(StdioSnprintf), PROTO("int snprintf(char *, int, char *, ...);") },
    { FUNC(StdioScanf),    PROTO("int scanf(char *, ...);") },
    { FUNC(StdioFscanf),   PROTO("int fscanf(FILE *, char *, ...);") },
    { FUNC(StdioSscanf),   PROTO("int sscanf(char *, char *, ...);") },
    { FUNC(StdioVprintf),  PROTO("int vprintf(char *, va_list);") },
    { FUNC(StdioVfprintf), PROTO("int vfprintf(FILE *, char *, va_list);") },
    { FUNC(StdioVsprintf), PROTO("int vsprintf(char *, char *, va_list);") },
    { FUNC(StdioVsnprintf),PROTO("int vsnprintf(char *, int, char *, va_list);") },
    { FUNC(StdioVscanf),   PROTO("int vscanf(char *, va_list);") },
    { FUNC(StdioVfscanf),  PROTO("int vfscanf(FILE *, char *, va_list);") },
    { FUNC(StdioVsscanf),  PROTO("int vsscanf(char *, char *, va_list);") },
    { NILFUNC,             NILPROTO}
};
