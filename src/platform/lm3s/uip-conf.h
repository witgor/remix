...
//
typedef struct picoc_uip_state uip_tcp_appstate_t;
...
//
#ifndef UIP_APPCALL
#define UIP_APPCALL                 picoc_uip_appcall
#endif

#ifndef UIP_ADP_APPCALL
#define UIP_UDP_APPCALL             picoc_uip_udp_appcall
#endif

// Added for eLua: DHCP TIMER ID
#define PICOC_DHCP_TIMER_ID          1
