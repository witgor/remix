...
# specific_files = "startup_gcc.c platform.c uart.c timer.c gpio.c sysctl interrupt.c cpu.c platform_int.c"
...
comp.Append(LINKFLAGS = ['-nostartfiles','-nostdlib','-T',ldscript,'-Wl,--gc-sections','-Wl,--allow-multiple-definition','-Wl,-Map=remix.map'])
