...
int platform_can_recv( unsigned id, u32 *canid, u8 *idtype, u8 *len, u8 *data )
{
  ...
  if( can_rx_flag != 0 )
  {
    ...
    *idtype = ( can_msg_rx.ulFlags & MSG_OBJ_EXTENDED_ID )? PICOC_CAN_ID_EXT : PICOC_CAN_ID_STD;
...
/**
 * FIXME: Need to make lm3s_disp_* target specific.
 * Write a seperate structure for disp.
 */
